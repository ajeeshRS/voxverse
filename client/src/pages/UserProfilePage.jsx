      ...
      <div className="pl-5">
        <div className="flex items-center pl-10 pt-10">
          <div className="relative group">
            ...
            <button className="absolute bottom-0 right-0 m-2  opacity-0 transition-opacity duration-300 group-hover:opacity-100" onClick={()=>navigate("/update-avatar")}>
          ...
          <button
            className="bg-black text-white text-xs font-poppins px-2 py-2 rounded-full ml-10 hover:bg-white hover:text-black border-black border-2 transition-all duration-300"
